...
export const ALLOWED_WORKSPACE_DEPS = {
  // Root is tooling (e2e tests import the contracts schemas and, since 1.18's
  // tests/tsconfig.json coverage fix, the core package surface), not a
  // shipped package. Core's own LLM-free wall is unaffected.
  "(root)": ["@agentic-guardrails/contracts", "@agentic-guardrails/core"],
  contracts: [],
