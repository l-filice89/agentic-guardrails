...
|---|---|---|---|
| [ADR-001](./ADR-001-llm-envelope.md) | LLM contract envelope | Accepted | Story 1.2 |
| [ADR-002](./ADR-002-repo-layout.md) | Repo layout (pnpm workspaces + TS project references) | Accepted | Story 1.1 |
| ADR-003 | Orchestration (static six-phase pipeline + p-map) | Planned | Story 1.7 |
| ADR-004 | AST tooling (ts-morph LanguageAdapter) | Planned | Story 1.3 |
| [ADR-005](./ADR-005-contracts-package.md) | Contracts package (standalone pure-Zod source of truth) | Accepted | Story 1.1 |

The numbering gap (003, 004 missing here) is intentional: those ADRs are written
